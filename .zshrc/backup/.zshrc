...
export GITPATH=https://github.com/yatimisi2018
export ZSHPATH=~/.my-zsh
...
#----
export autosuggestions=~/.zsh/zsh-autosuggestions
export highlighting=/usr/local/share/zsh-syntax-highlighting
#----
